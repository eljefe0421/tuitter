...
export function renderUserInfo(user, state = {}) {
    ...
    const showInlineAvatarOverlay = Boolean(state.useInlineAvatarOverlay && state.avatarAnchorId && user.profile_image_url);
    return Box({
        width: "100%",
        borderStyle: "rounded",
        ...
        }, Text({ content: "[@]", fg: theme.textMuted })), Text({
